globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/layout-segment-context-7Nb4TNYX.js","assets/page-D4bQrWda.js"];
...
function getDraftSecret() {
	return "103297c7-e96a-4bfa-9093-c795c77ac461";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2c3eca9b-7c58-4b3d-ae2b-51742d5a60cd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2c3eca9b-7c58-4b3d-ae2b-51742d5a60cd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2c3eca9b-7c58-4b3d-ae2b-51742d5a60cd",
		rootBoundaryId
	});
}
/**
...
var USER_ID_HEADER = "oai-authenticated-user-id";
...
//#endregion
//#region app/api/me/route.ts
var route_exports = /* @__PURE__ */ __exportAll({ GET: () => GET });
var ADMIN_EMAILS = new Set(["doliy4784@gmail.com"]);
async function GET() {
...
var routes = [{
	...
	ids: {
		"route": "route:/api/me",
		"page": null,
		"routeHandler": "route-handler:/api/me",
		"rootBoundary": "root-boundary:/",
		"layouts": ["layout:/"],
		"templates": [],
		"slots": {}
