...
var client_references_default = {
	"5b59d0314280": async () => {
		const m = await import("./assets/layout-segment-context-DpeI1mJo.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"6efdf509a785": async () => {
		const m = await import("./assets/page-BPWxelVo.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"e43174d2e269": async () => {
		const m = await import("./assets/error-boundary-1WM_1449.js");
		return {
			get "ErrorBoundary"() {
